...
<div class="space-y-6 pb-12">
    ...
    <div class="flex flex-col gap-2">
        <nav class="flex text-sm text-slate-400 font-medium">
            <a href="halaqah.php" class="hover:text-cyan-600 transition-colors">Data Halaqah</a>
            <span class="mx-2 text-slate-300">/</span>
            <span class="text-slate-600">Anggota Kelompok</span>
        </nav>
        <div class="sm:flex sm:items-center sm:justify-between">
            <div>
                <h1 class="text-2xl font-bold text-slate-800"><?php echo htmlspecialchars($group['group_name']); ?></h1>
                <p class="text-slate-500 mt-1">Pengampu: <span class="font-semibold text-slate-700"><?php echo htmlspecialchars($group['teacher_name']); ?></span></p>
            </div>
            <div class="mt-4 sm:mt-0">
                <button onclick="openModal('modal-add-member')" 
                    ...
                    <i class="fa-solid fa-user-plus -ml-1 mr-2 h-4 w-4"></i>
                    Tambah Santri
                </button>
            </div>
        </div>
            ...
            <form action="../../logic/tahfidz/manage_halaqah.php" method="POST">
                ...
                <div class="bg-white px-8 pt-8 pb-6">
                    <div class="flex justify-between items-center mb-6">
                        <h3 class="text-xl font-bold text-slate-800">Tambah Santri ke Kelompok</h3>
                    ...
                    <div class="relative mb-6">
                        ...
                        <input type="text" id="member-search" onkeyup="filterStudents()" 
                            class="block w-full pl-10 pr-4 py-3 border border-slate-200 rounded-xl bg-slate-50 text-sm focus:ring-cyan-500 focus:border-cyan-500 transition-all" 
                    ...
                    <div class="space-y-4">
                        <div class="flex items-center justify-between mb-2 px-1">
                            ...
                            <label class="flex items-center gap-2 cursor-pointer group">
                                ...
                                <span class="text-xs font-bold text-slate-500 group-hover:text-cyan-600 transition-colors">Pilih Semua</span>
                            </label>
                            <?php endif; ?>
                        </div>
                           ...
                           <div class="grid grid-cols-1 gap-2">
                               <?php if (count($available_students) > 0): ?>
                                   <?php foreach ($available_students as $s): ?>
                                       <label class="student-item flex items-center p-3 rounded-xl border border-slate-200 hover:border-cyan-300 hover:bg-cyan-50 cursor-pointer transition-all group" 
