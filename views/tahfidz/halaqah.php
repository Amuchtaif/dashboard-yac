    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <?php else: ?>
            <div
                ...
                <i class="fa-solid fa-users h-16 w-16 mb-4 text-slate-200"></i>
                            ...
                            <div class="relative" id="teacher-dropdown">
                                ...
                                <button type="button" id="teacher-dropdown-btn" onclick="toggleTeacherDropdown('add')"
                                    ...
                                    <span id="teacher-dropdown-text" class="text-slate-400 truncate">Pilih
                                        Pengampu...</span>
                                    <i id="teacher-dropdown-arrow-add" class="fa-solid fa-chevron-down h-4 w-4 text-slate-400 flex-shrink-0 ml-2 transition-transform duration-200"></i>
                                </button>
                                ...
                                <div id="teacher-dropdown-menu-add"
                                    ...
                                    <ul id="teacher-options-list-add" class="overflow-y-auto"
                                        ...
                                        <li id="teacher-no-result-add"
                                            ...
                                            <i class="fa-solid fa-face-frown h-6 w-6 mx-auto mb-1 text-slate-300"></i>
                        ...
                        <div>
                            ...
                            <div class="relative" id="teacher-dropdown-edit">
                                ...
                                <button type="button" id="edit-teacher-dropdown-btn"
                                    ...
                                    <i id="teacher-dropdown-arrow-edit" class="fa-solid fa-chevron-down h-4 w-4 text-slate-400 flex-shrink-0 ml-2 transition-transform duration-200"></i>
                                </button>
