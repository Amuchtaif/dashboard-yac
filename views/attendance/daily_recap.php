...
<div class="pb-10">
    <div class="sm:flex sm:items-center mb-8">
        ...
        <div class="mt-4 sm:ml-16 sm:mt-0 flex gap-3">
            <a href="export_daily_recap_pdf.php?<?php echo http_build_query($_GET); ?>" target="_blank"
                ...
                <svg class="-ml-1 mr-2 h-4 w-4 text-rose-500" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
