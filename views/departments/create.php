...
<div class="max-w-3xl mx-auto pb-10">
    ...
    <div class="mb-8">
        <h1 class="text-2xl font-bold text-slate-900">Tambah Bidang Baru</h1>
        <p class="mt-2 text-sm text-slate-600">Buat bidang baru untuk mengatur tenaga kerja Anda.</p>
    </div>
                    ...
                    <div class="sm:col-span-4">
                        ...
                        <div class="mt-2">
                            <div
                                ...
                                <span class="flex select-none items-center pl-3 text-gray-500 sm:text-sm">Bdg.</span>
