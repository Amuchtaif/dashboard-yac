        ...
        <nav class="space-y-1">
            ...
            <?php if ($can_manage_employees): ?>
                ...
                <a href="<?php url('views/work_reports/index.php'); ?>"
                    class="<?php echo isActive('work_reports'); ?> group flex items-center px-3 py-2.5 text-sm font-medium rounded-lg transition-all duration-200">
                    <svg class="mr-3 flex-shrink-0 h-5 w-5 <?php echo getIconClass('work_reports'); ?> transition-colors"
                        xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                        stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round"
