    ...
    <div
        ...
        <nav class="space-y-1">
            ...
            <a href="<?php url('views/assessment_types/index.php'); ?>"
                class="<?php echo isActive('assessment_types'); ?> group flex items-center px-3 py-2.5 text-sm font-medium rounded-lg transition-all duration-200">
                <svg class="mr-3 flex-shrink-0 h-5 w-5 <?php echo getIconClass('assessment_types'); ?> transition-colors"
                    xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                    stroke="currentColor">
            ...
            <a href="<?php url('views/boarding/violation_types/index.php'); ?>"
                ...
                <svg class="mr-3 flex-shrink-0 h-5 w-5 <?php echo getIconClass('boarding/violation_types/index.php'); ?> transition-colors"
                    xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                    stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M8.25 6.75h12M8.25 12h12m-12 5.25h12M3.75 6.75h.007v.008H3.75V6.75zm.375 0a.375.375 0 11-.75 0 .375.375 0 01.75 0zM3.75 12h.007v.008H3.75V12zm.375 0a.375.375 0 11-.75 0 .375.375 0 01.75 0zm-2.25 5.25h.008v.008H1.875V17.25zm.375 0a.375.375 0 11-.75 0 .375.375 0 01.75 0z" />
                </svg>
                Jenis Pelanggaran
            </a>
