...
<body class="p-8 bg-white text-slate-900" onload="window.print()">
    ...
    <div class="mb-8 border-b border-slate-200 pb-4 flex justify-between items-end">
        <div>
            <h1 class="text-2xl font-bold uppercase tracking-wide text-slate-800">Data Pegawai</h1>
        ...
        <table class="min-w-full text-left text-xs whitespace-nowrap">
            <thead>
                <tr class="border-b border-slate-300">
                    <th class="py-2 pr-4 font-bold uppercase text-slate-500">No.</th>
                    <th class="py-2 pr-4 font-bold uppercase text-slate-500">Nama Lengkap</th>
                    <th class="py-2 pr-4 font-bold uppercase text-slate-500">Jabatan</th>
                    <th class="py-2 pr-4 font-bold uppercase text-slate-500">Bidang / Unit</th>
                    <th class="py-2 pr-4 font-bold uppercase text-slate-500">Kontak</th>
                </tr>
            </thead>
